...
class DetallesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detalle" do
    assert_difference('Detalle.count') do
      post detalles_url, params: { detalle: { Libro_id: @detalle.Libro_id, cantidad: @detalle.cantidad, prestamos_id: @detalle.prestamos_id } }
    end
  ...
  test "should update detalle" do
    patch detalle_url(@detalle), params: { detalle: { Libro_id: @detalle.Libro_id, cantidad: @detalle.cantidad, prestamos_id: @detalle.prestamos_id } }
